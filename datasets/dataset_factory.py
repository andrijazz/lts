...
def build_dataset(dataset_name, transform, train=False):
    ...
    if dataset_name == "imageneto":
        dataset = torchvision.datasets.ImageFolder(os.path.join(dataset_dir, 'imagenet-o'), transform=transform)
        return dataset
    ...
    if dataset_name == "imagenet":
        ...
        # dataset = torchvision.datasets.ImageFolder(os.path.join(dataset_dir, 'imagenet_1k'),
        #                                            transform=transform)
        return dataset

    if dataset_name == 'inaturalist':
        dataset = torchvision.datasets.ImageFolder(os.path.join(dataset_dir, 'iNaturalist'), transform=transform)
        # dataset = torchvision.datasets.ImageFolder(os.path.join(dataset_dir, 'openood/images_largescale/inaturalist'), transform=transform)
        return dataset
    ...
    if dataset_name == 'ninco':
        dataset = torchvision.datasets.ImageFolder(os.path.join(dataset_dir, 'ninco'), transform=transform)
        return dataset

    if dataset_name == 'ssb_hard':
        dataset = torchvision.datasets.ImageFolder(os.path.join(dataset_dir, 'ssb_hard'), transform=transform)
        return dataset

    if dataset_name == 'openimage_o':
        dataset = torchvision.datasets.ImageFolder(os.path.join(dataset_dir, 'openimage_o'), transform=transform)
        return dataset
